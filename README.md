...
7. mergenote 명령어로 이미 존재하는 단어장의 이름을 사용할 수 있는 버그를 고침  
8. appendword 명령어에서 접속중인 단어장이 없어도 단어장의 이름을 출력하는 버그를 고침  
9. pullword 명령어에서 오타 수정  
10. pullword, modifyword, deleteword 명령어에서 지워진 단어의 뜻을 선택할 수 있는 버그를 고침  
11. mergenote 명령어에서 이미 존재하는 단어장의 이름을 사용하고자 할 때 NOTELIST에 단어장 이름이 쌓이는 버그를 고침   
12. addnote 명령어에서 비정상적으로 이미 존재하는 단어장이라고 출력하는 버그를 고침   
13. addnote 명령어에서 이미 존재하는 단어장을 지우고 새로만들 때 NOTELIST에 단어장 이름이 쌓이는 버그를 고침
